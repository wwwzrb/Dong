...
<div class="ui fixed inverted menu">
    ...
    <a class="item active" href="person.action?userId=<s:property value="#user.userId"/>">个人动态</a>
    <a class="item" href="friend.action?userId=<s:property value="#user.userId"/>">好友管理</a>
    <a class="item">群组管理</a>
...
<div class="container">
    <div class="main">
        ...
        <s:iterator value="#session['person']" id="publish">
        <div class="ui feed">
